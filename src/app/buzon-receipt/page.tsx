...
const BuzonRecepcion = () => {
    ...
    <TableCaption className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Detalles de Recepción</TableCaption>
    <TableHeader>
        <TableRow className="bg-[#28603B]">
            <TableHead className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Tipo de Transferencia</TableHead>
            <TableHead className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Numero de Proceso CD</TableHead>
            <TableHead className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Nombre de Archivo</TableHead>
            <TableHead className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Ruta Origen</TableHead>
            <TableHead className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Ruta Destino</TableHead>
            <TableHead className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Fecha</TableHead>
            <TableHead className="text-gray-800 bg-[#28603B] p-2 text-white rounded-t-lg">Detalle</TableHead>
        </TableRow>
    </TableHeader>
    <TableBody>
        <TableRow className="hover:bg-gray-100">
            <TableCell className="font-medium text-gray-800">Recepcion</TableCell>
        ...
        <TableRow className="hover:bg-gray-100">
            <TableCell className="font-medium text-gray-800">Recepcion</TableCell>
            <TableCell className="text-center text-gray-700">993645</TableCell>
            <TableCell className="text-center text-gray-700">20240422_AF_556_016_00000.006.gpg</TableCell>
            <TableCell className="text-center text-gray-700">repore/envio/355/</TableCell>
            <TableCell className="text-center text-gray-700">repore/envio/355/</TableCell>
            <TableCell className="text-center text-gray-700">2024/06/18 10:00</TableCell>
        ...
        <TableRow className="hover:bg-gray-100">
            <TableCell className="font-medium text-gray-800">Recepcion</TableCell>
            <TableCell className="text-center text-gray-700">998445</TableCell>
            <TableCell className="text-center text-gray-700">20240422_AF_556_016_00000.006.gpg</TableCell>
            <TableCell className="text-center text-gray-700">repore/envio/355/</TableCell>
            <TableCell className="text-center text-gray-700">repore/envio/355/</TableCell>
            <TableCell className="text-center text-gray-700">2024/06/18 10:00</TableCell>
        ...
        <TableRow className="hover:bg-gray-100">
            <TableCell className="font-medium text-gray-800">Recepcion</TableCell>
            <TableCell className="text-center text-gray-700">986645</TableCell>
            <TableCell className="text-center text-gray-700">20240422_AF_556_016_00000.006.gpg</TableCell>
            <TableCell className="text-center text-gray-700">repore/envio/355/</TableCell>
            <TableCell className="text-center text-gray-700">repore/envio/355/</TableCell>
            <TableCell className="text-center text-gray-700">2024/06/18 10:00</TableCell>
