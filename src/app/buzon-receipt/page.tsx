    ...
    <div className="flex-1 items-center justify-left rounded-lg border border-dashed shadow-sm p-4">
        <div>
            <div className="flex items-center gap-4">
                ...
                <input type="text" id="tipoTransferencia" name="tipoTransferencia" className="p-2 border rounded-md w-40 bg-gray-100 text-gray-500 cursor-not-allowed" value="Recepcion" readOnly/>
            </div>
            <br />
            <div className="flex items-center gap-4">
...
<Table>
  ...
  <TableBody>
    <TableRow>
      <TableCell className="font-medium">Recepcion</TableCell>
